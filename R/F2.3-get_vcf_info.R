...
# helper function: extract_allelic_dist
        ...
        # vcf_data_df = as.data.frame(vcf_data_gr) # Here "as.data.frame" sometimes doesn't work!
...
get_vcf_info_main = function(snp_info_file, vcf_dir = NA, vcf_file = NA, output_dir = "./", sample_name = "", output_file = NA) {
        # Test #
        # snp_info_file = "./LUC_Index_SNPs_20160607_short_A549_bySample_assnp/LUC_Index_SNPs_20160607_short_riskPop_0.5.csv"
        # vcf_dir = "../00-AlleleSNP/data/samples/DDBJ_A549/vcf_files/"
        # vcf_file = NA
        # output_dir = "./"
        # sample_name = ""
        # output_file = NA
...
# get_vcf_info_main(snp_info_file = snp_file_loc, vcf_dir = "../00-AlleleSNP/data/samples/DDBJ_A549/vcf_files/")
