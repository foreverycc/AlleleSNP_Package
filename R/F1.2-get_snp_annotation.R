...
gen_output_file_list = function(snp_info_file, output_dir = "./") {
        ...
        utr_snp_info_file = paste0(output_dir, "/", snp_batch_id, "_3-utr_snp_info.csv")
        promoter_snp_info_file = paste0(output_dir, "/", snp_batch_id, "_5-utr&promoter_snp_info.csv")
        ...
        utr_snp_annovar_file = paste0(output_dir, "/", snp_batch_id, "_3-utr_snp_annovar.txt")
...
write_coding_snp_table = function(snp_info_df, output_list) {
        ...
        ## UTR
        write.csv(filter(snp_info_df, grepl("3-UTR", annotation_edit)), output_file_list$utr_snp_info_file)
        ## promoter
        write.csv(filter(snp_info_df, grepl("5-UTR", annotation_edit) | annotation_edit == "Promoter"), output_file_list$promoter_snp_info_file)
...
write_annovar_files = function(snp_info_df, output_file_list) {
        ...
        snp_info_df_utr = filter(snp_info_df, grepl("3-UTR", annotation_edit))
